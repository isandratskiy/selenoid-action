...
async function replaceVersions(_chrome, _firefox) {
    ...
    fs__WEBPACK_IMPORTED_MODULE_1__.writeFile('browsers.json', browsersJson, err => {
        if (err) {
            _actions_core__WEBPACK_IMPORTED_MODULE_0__.error(err.message);
            throw err;
        }
        _actions_core__WEBPACK_IMPORTED_MODULE_0__.info('Created browsers.json config');
    });
}
replaceVersions('99', '88').catch(err => {
    _actions_core__WEBPACK_IMPORTED_MODULE_0__.error(err.message);
});
